...
#
	   ...
	   #  Open a file
           ...
           codeDirectory = "/home/irsyad/ros_noetic_ws/src/MakeROSMap/"
           print("Current working directory")
           print(os.getcwd())
           
           #completeFileNameMap = os.path.join(mapLocation, mapName +".pgm")
           #completeFileNameYaml = os.path.join(mapLocation, mapName +".yaml")
           completeFileNameMap = os.path.join(codeDirectory, mapName +".pgm")
           completeFileNameYaml = os.path.join(codeDirectory, mapName +".yaml")
	   ...
	   #
           ...
           yaml.write("image: " + codeDirectory + mapName + ".pgm\n")
